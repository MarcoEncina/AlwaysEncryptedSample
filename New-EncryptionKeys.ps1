...
[cmdletbinding()]
param(
	[string] $ConnectionString = "Data Source=localhost,1433;Initial Catalog=AlwaysEncryptedSample;UID=sa;PWD=alwaysB3Encrypt1ng;Application Name=New-EncryptionKeys.ps1;Column Encryption Setting=enabled;",
...
if ($RemoveExistingCerts) {
    ...
    # TODO: Make this not thow an error if the key doesn't exist
